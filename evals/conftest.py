"""Shared fixtures for Yoga Practice Guide chatbot evals.

Provides core helpers:
  - `get_answer`: sends a question to the yoga bot, returns its response.
...
from app import MODEL, build_initial_messages, check_safety  # noqa: E402
...
def get_answer(question: str) -> str:
    """Send a question to the yoga bot and return its response.

    Respects the safety backstop — if the question triggers it, the safety
    response is returned directly (matching the real /chat endpoint behavior).
    """
